                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php
                        if(isset($_SESSION["idpaciente"])){
                            ...
                            echo "<a href='dashboard_paciente.php' class='navbar-font btn me-2 section-btn2' type='button'><i class='bi bi-arrow-return-right'></i> Área do Paciente</a>";
                            ...
                            echo "<form class='d-flex'>";
                            echo "<a href='dashboard_psicologo.php' class='navbar-font btn me-2 section-btn2' type='button'><i class='bi bi-arrow-return-right'></i> Área do Psicólogo</a>";
                            echo  "<a href='includes/logout_inc.php' class='navbar-font btn navbar-login_sair' type='button'>Sair</a>";
                            echo "</form>";
                        }
                        else{
