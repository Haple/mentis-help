...
<div class="container p-5">
    <h2 class="pb-4 card-title text-center">Anorexia</h2>
    <img src="../../resources/anorexia.png" class="w-25 center-img d-none d-lg-block" alt="">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            ...
            <p class="lead subtopic-content pb-3">O individuo acaba por desenvolver um medo extremo de engordar, embora
