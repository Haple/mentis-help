...
<div class="container p-5">
    <h2 class="pb-4 card-title text-center">Fobia Social</h2>
    <img src="../../resources/fobiasocial.png" class="w-25 center-img d-none d-lg-block" alt="">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            ...
            <p class="lead subtopic-content">Fobia social é uma doença mental crônica na qual as relações acabam
                ...
                social. </p>
            <p class="lead subtopic-content pb-3">Situações como manifestar a opinião em uma discussão, atender o
                telefone no ambiente escolar ou de trabalho e iniciar algum relacionamento são tão complicadas de se
