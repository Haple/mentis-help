...
<div class="container p-5">
    <h2 class="pb-4 card-title text-center">Bulimia</h2>
    <img src="../../resources/bulimia.png" class="w-25 center-img d-none d-lg-block" alt="">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            ...
            <p class="lead subtopic-content">Bulimia é um transtorno alimentar causado por uma distúrbio psíquico que
                ...
                fatal. </p>
            <p class="lead subtopic-content pb-3">Muitas vezes a pessoa consome grandes quantidades de comida com alto
                teor calórico e em seguida se força a métodos para evitar o ganho de peso, tais como vomitar, praticar
