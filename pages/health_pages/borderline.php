...
<div class="container p-5">
    <h2 class="pb-4 card-title text-center">Transtorno Borderline</h2>
    <img src="../../resources/borderline.png" class="w-25 center-img d-none d-lg-block" alt="">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            ...
            <p class="lead subtopic-content pb-3">O indivíduo que possui tal transtorno tende a apresentar uma
                hiper-reatividade afetiva, assim vendo muitas situações boas como ótimas e muitas situações ruins como
                péssimas; desta forma, qualquer quebra de expectativa, principalmente dentro de relacionamentos,
