...
<div class="container p-5">
    <h2 class="pb-4 card-title text-center">Síndrome de Burnout</h2>
    <img src="../../resources/burnout.png" class="w-25 center-img d-none d-lg-block" alt="">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            ...
            <p class="lead subtopic-content pb-3">Atinge principalmente profissionais cuja profissão requer algum
                envolvimento emocional entre as pessoas, como nas áreas da educação, saúde, recursos humanos e
